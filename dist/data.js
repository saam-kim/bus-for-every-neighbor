...
export const SCENARIO={id:'morning-v1',start:420,end:600,dwell:1,turn:2,transfer:2};
export const STOPS=[
...
export const RESIDENTS=[
 ...
 {id:'seongho',name:'성호',role:'환승센터 근로자',portrait:6,home:'아파트',destination:'환승센터',ready:442,deadline:495,walk:'한 번에 10분까지 보행',maxWalk:10,low:false,access:{A:5},egress:{T:3},story:'8시 15분까지 환승센터 안내소로 출근해요. 노선이 돌아가면 출근 시간이 달라져요.'},
 {id:'mansu',name:'만수',role:'재활 진료 주민',portrait:7,home:'언덕마을',destination:'병원',ready:455,deadline:550,walk:'한 번에 10분 · 천천히 보행',maxWalk:10,low:false,access:{H:9},egress:{M:8},story:'8시 이후 버스라도 괜찮아요. 9시 10분 재활 진료 전에 병원에 도착하면 돼요.'},
 ...
 {id:'taesik',name:'태식',role:'공장 근로자',portrait:9,home:'언덕마을',destination:'공장',ready:425,deadline:480,walk:'한 번에 25분까지 보행',maxWalk:25,low:false,access:{H:5,N:25},egress:{F:5},story:'7시 5분부터 나갈 수 있어요. 언덕 아래까지 걸어갈 수는 있지만 8시 출근에 맞춰야 해요.'},
 {id:'sujin',name:'수진',role:'고등학생',portrait:10,home:'아파트',destination:'학교',ready:450,deadline:510,walk:'한 번에 12분까지 보행',maxWalk:12,low:false,access:{A:4},egress:{S:5},story:'아침 돌봄을 마치고 7시 30분에 출발해요. 8시 30분 동아리 활동에 참여하고 싶어요.'},
...
export const DEFAULT_DESIGN={buses:[{route:['A','T','N','S'],departure:450},{route:['T','E','F'],departure:450}],lowBus:0};
